...
init()
system("mode 800")
system("title TikTok Botter -By Dreamer#5114 (Edited by Jakee#8718")
system("This python creation is for educational purposes. Don't use this on other people because they can be banned yeah")
